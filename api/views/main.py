...
def index():
    ...
    middleinitial = 'A.'
    lastname = 'Mitchell'
    tagline = 'Quality Assurance | Software & Game Development | Test Automation | C# | Python | TypeScript'
    logger.info("Load Profile")
    return render_template('index.html', title='Portfolio', firstname=firstname, middleinitial=middleinitial, lastname=lastname, tagline=tagline)
